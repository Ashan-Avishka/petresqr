...
import { ShoppingCart, Trash2, Plus, Minus, ArrowRight, ArrowLeft, Package, CreditCard, MapPin, Check, Tag } from 'lucide-react';

export default function CartPage() {
  const [cartItems, setCartItems] = useState([
    {
      id: 1,
      name: "Premium Pet Tag - Gold",
      price: 29.99,
      quantity: 1,
      image: "https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=400&h=400&fit=crop",
      color: "Gold",
      engraving: "Max - 555-0123"
    },
    {
      id: 2,
      name: "Smart QR Pet Tag",
      price: 39.99,
      quantity: 1,
      image: "https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=400&h=400&fit=crop",
      color: "Silver",
      engraving: "Luna - 555-0456"
    }
  ]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary via-black to-black shadow-md py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl px-4 mx-auto pt-30">
        {/* Header */}
        {/* <motion.div
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={addToCart}
            className="bg-gradient-to-r from-amber-500 to-amber-600 text-white px-6 py-3 rounded-full shadow-lg flex items-center gap-2 hover:shadow-xl transition-shadow"
          >
              ...
              <div key={step.number} className="flex items-center flex-1">
                ...
                {index < steps.length - 1 && (
                  <div className="flex-1 h-1 mx-2 sm:mx-4">
                    <div className={`h-full rounded transition-all duration-500 -mt-3 ${
                      currentStep > step.number ? 'bg-primary' : 'bg-white'
                    }`} />
                  </div>
                )}
              </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 ">
                        ...
                        >
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-400 mb-2">
                              Color: {item.color} | Engraving: {item.engraving}
                            </p>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border border-gray-400/50 rounded-lg focus:ring-1 focus:ring-amber-500 focus:border-transparent outline-none transition-all"
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 0.5 }}
                      className="bg-white/20 border border-white/20 rounded-lg p-4 mt-6"
                    >
              ...
              {currentStep === 4 && (
                ...
                >
                  ...
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-3 bg-gradient-to-br shadow-primary from-primary to-black text-white rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-all"
                  >
                    Track Your Order
                  </motion.button>
                </motion.div>
              ...
              >
                {currentStep > 1 && (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={prevStep}
                    className="flex items-center gap-2 px-6 py-3 bg-transparent shadow-md shadow-primary text-gray-300 rounded-lg"
                  >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={nextStep}
                  disabled={cartItems.length === 0 && currentStep === 1}
                  className={`flex items-center gap-2 px-6 py-3 rounded-full ml-auto ${
                    cartItems.length === 0 && currentStep === 1
                      ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                      : 'bg-gradient-to-br shadow-primary from-primary to-black text-white rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-all'
                  } transition-all`}
                >
          ...
          >
            <div className="bg-gradient-to-br shadow-primary from-primary to-black shadow-md rounded-2xl p-6">
              ...
              <div className="mb-6">
                <div className="flex gap-2">
                  <div className="flex-1 relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 text-white border border-white rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none disabled:bg-gray-100"
                    />
                  </div>
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    ...
                    disabled={appliedPromo}
                    className="px-4 py-2 bg-gradient-to-br shadow-primary from-primary to-black shadow-md text-white rounded-lg hover:bg-amber-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
                  >
                    Apply
                  </motion.button>
                </div>
                ...
                <p className="text-xs text-white mt-2">Try code: SAVE10</p>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <h4 className="font-semibold text-white mb-4">Items ({cartItems.length})</h4>
